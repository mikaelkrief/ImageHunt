...
namespace ImageHuntBotBuilder.Commands
{
    ...
    public class RedeemCommand : AbstractCommand, IRedeemCommand
    {
        ...
        public RedeemCommand(ILogger<IRedeemCommand> logger, IPasscodeWebService passcodeWebService,
            ILifetimeScope scope, IStringLocalizer<RedeemCommand> localizer)
