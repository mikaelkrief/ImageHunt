...
namespace ImageHuntBotBuilder.Commands
{
    ...
    public class RenameChatCommand : AbstractCommand, IRenameChatCommand
    {
        ...
        public RenameChatCommand(ILogger<IRenameChatCommand> logger, IGameWebService gameWebService,
            ITeamWebService teamWebService, IStringLocalizer<RenameChatCommand> localizer)
