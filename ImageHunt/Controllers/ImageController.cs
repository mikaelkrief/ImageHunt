...
namespace ImageHunt.Controllers
{
  ...
  public class ImageController : ControllerBase
  {
    ...
    [HttpGet("Thumbnail")]
    public async Task<IActionResult> GetThumbailById([FromQuery] int pictureId, [FromQuery] int width,
    ...
    public async Task<IActionResult> GetImageAndthumbnailById([FromQuery] int pictureId, [FromQuery] int thumbnailWidth,
      [FromQuery] int thumbnailHeight)
    {
      var picture = await _imageService.GetPictureById(pictureId);
      ...
      return Ok(new[]
      {
        File(thumbnail, "image/jpeg", "thumnbnail"),
