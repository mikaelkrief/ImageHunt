...
namespace ImageHunt.Controllers
{
  ...
  public class AuthController : Controller
  {
    ...
    [HttpPost("github")]
    public async Task<IActionResult> GitHubSignIn([FromBody]JObject bearer)
    {
      var content = new FormUrlEncodedContent(new[]
      {
        new KeyValuePair<string, string>("code", bearer["code"].Value<string>()),
        new KeyValuePair<string, string>("client_id", _configuration["GoogleGithubApiApi:ClientId"]),
        new KeyValuePair<string, string>("client_secret", _configuration["GoogleGithubApiApi:ClientSecret"]),
        new KeyValuePair<string, string>("redirect_uri", bearer["redirectUri"].Value<string>()),
        new KeyValuePair<string, string>("grant_type", "authorization_code"),
