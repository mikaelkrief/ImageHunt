...
@NgModule({
  ...
  declarations: [GeocoordinateComponent, GoogleButtonComponent,
    GameActionTranslationPipe, UserRoleComponent, DualListComponent,
    UploadImageComponent],
  bootstrap: [GeocoordinateComponent, GoogleButtonComponent, UserRoleComponent, UploadImageComponent, DualListComponent],
  exports: [GeocoordinateComponent, GoogleButtonComponent, GameActionTranslationPipe, UserRoleComponent, DualListComponent]
