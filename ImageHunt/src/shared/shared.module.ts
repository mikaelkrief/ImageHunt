...
@NgModule({
  ...
  declarations: [
    GeocoordinateComponent, GameActionTranslationPipe,
  ...
  bootstrap: [
    GeocoordinateComponent, UserRoleComponent, UploadImageComponent,
    DualListComponent, LoginButtonComponent, UppyComponent
  ],
  exports: [
    GeocoordinateComponent, GameActionTranslationPipe, DateFilterPipe, SortPipe, MomentFormatPipe,
