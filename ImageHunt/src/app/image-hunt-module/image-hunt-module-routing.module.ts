...
const routes: Routes = [
  ...
  { path: "gameteam/:gameCode", component: GameTeamsComponent},
  ...
  { path: "score/:gameId", component: ScoreListComponent, canActivate: [AuthGuard], data: { roles: ["Admin", "GameMaster", "Validator"] } },
  { path: "follow/:gameId", component: TeamFollowComponent, canActivate: [AuthGuard], data: { roles: ["Admin", "GameMaster", "Validator"] } },
