...
const routes: Routes = [
  ...
  { path: "game", component: GameListComponent, canActivate: [AuthGuard], data: { roles: ["Admin", "GameMaster"] } },
  {
    ...
    data: { roles: ["Admin", "GameMaster"] }
  },
  {
    path: "action/:gameId",
    component: GameActionListComponent,
    canActivate: [AuthGuard],
    data: { roles: ["Admin", "GameMaster", "Validator"] }
  },
  {
    path: "action/:gameId/:teamId",
    component: GameActionListComponent,
    canActivate: [AuthGuard],
    data: { roles: ["Admin", "GameMaster", "Validator"] }
  },
  {
    path: "action/detail/:gameActionId",
    component: GameActionDetailComponent,
    canActivate: [AuthGuard],
    data: { roles: ["Admin", "GameMaster", "Validator"] }
  },
  ...
  {
    path: "gameteam/:gameCode",
    component: GameTeamsComponent,
    canActivate: [AuthGuard],
    data: { roles: ["Admin", "TeamLeader", "Player"] }
  },
  ...
  {
    path: "passcode/:gameId",
    component: PasscodeListComponent,
    canActivate: [AuthGuard],
    data: { roles: ["Admin", "GameMaster"] }
  },
  {
    path: "passcode/print/:gameId",
    component: PasscodePrintComponent,
    canActivate: [AuthGuard],
    data: { roles: ["Admin", "GameMaster"] }
  },
