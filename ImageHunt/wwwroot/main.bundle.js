...
var GameDetailComponent = (function () {
    ...
    GameDetailComponent.prototype.saveChanges = function (gameId) {
        var _this = this;
        this.newRelations.forEach(function (r) { return __WEBPACK_IMPORTED_MODULE_10_rxjs_Observable__["Observable"].forkJoin(_this._gameService.addRelation(r.orgId, r.destId)).subscribe(function () { return _this.getGame(gameId); }); });
    };
...
var GameListComponent = (function () {
    ...
    GameListComponent.prototype.createGame = function (form) {
        ...
        var game = { id: 0, name: form.value.name, startDate: startDate, isActive: true, mapCenterLat: 0, mapCenterLng: 0, mapZoom: 12.0, nodes: null, teams: null };
...
var GUINode = (function (_super) {
    ...
    function GUINode(node) {
        ...
        _this.name = _this.nameWithIcon(node);
        return _this;
    }
    GUINode.prototype.nameWithIcon = function (node) {
        var nodeIcon = "";
