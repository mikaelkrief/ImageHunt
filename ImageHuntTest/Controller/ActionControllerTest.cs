...
namespace ImageHuntTest.Controller
{
    ...
    public class ActionControllerTest : BaseTest<ActionController>
    {
        ...
        {
            Check.That(picture.Image).IsNotNull().And.HasSize(10456);
            return true;
        }
        ...
        public void Reject()
        {
            ...
            A.CallTo(() => _actionService.Validate(1, A<int>._, 15, false)).MustHaveHappened();
        }
        ...
        public async Task GetGameActionsToValidate()
        {
            ...
            var gameActions = new List<GameAction>
          {
            ...
            A.CallTo(() => _actionService.GetGameActionsForGame(A<int>._, A<int>._, A<int>._, A<IncludeAction>._, A<int?>._)).MustHaveHappened();
