...
namespace ImageHuntValidator
{
    ...
    public class ImageHuntValidatorBotBot : IBot
    {
        ...
        public ImageHuntValidatorBotBot(ConversationState conversationState, ILoggerFactory loggerFactory)
        {
            ...
            _accessors = new ImageHuntValidatorBotAccessors(conversationState)
            {
        ...
        public async Task OnTurnAsync(ITurnContext turnContext, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            if (turnContext.Activity.Type == ActivityTypes.Message)
            {
                ...
                var state = await _accessors.ValidatorState.GetAsync(turnContext, () => new ImageHuntValidatorState());

                // Set the property using the accessor.
                await _accessors.ValidatorState.SetAsync(turnContext, state);
